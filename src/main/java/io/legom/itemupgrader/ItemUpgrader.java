package io.legom.itemupgrader;

import com.mojang.logging.LogUtils;

import io.legom.itemupgrader.api.ItemUpgraderRegistry;
import io.legom.itemupgrader.api.ingredient.TypedCriteria;
import io.legom.itemupgrader.api.ingredient.TypedIngredient;
import io.legom.itemupgrader.api.ingredient.UpgradeIngredient;
...
import io.legom.itemupgrader.client.ItemUpgraderClient;
import io.legom.itemupgrader.network.NetworkHandler;
import io.legom.itemupgrader.registry.ModUpgradeActions;
import io.legom.itemupgrader.registry.ModUpgradeConditions;
import io.legom.itemupgrader.registry.ModRecipes;
import io.legom.itemupgrader.registry.ModUpgradeResults;
import io.legom.itemupgrader.registry.ModTypedCriteria;
import io.legom.itemupgrader.registry.RegistryHelper;
import io.legom.itemupgrader.registry.config.Config;
