...
import io._3650.itemupgrader_content.upgrades.actions.special.ElytraLowFrictionUpgradeAction;
...
public class ModUpgradeActions {
	...
	public static final RegistryObject<ElytraLowFrictionUpgradeAction.Serializer> ELYTRA_LOW_FRICTION = ACTIONS.register("elytra_low_friction", () -> new ElytraLowFrictionUpgradeAction.Serializer());
