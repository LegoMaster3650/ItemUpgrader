...
public class TypedIngredient extends AbstractIngredient {
	...
	public TypedIngredient(ResourceLocation type) {
		super();
		this.type = type;
		this.criteria = !ItemUpgrader.TYPED_CRITERIA_REGISTRY.get().containsKey(this.type) ? TypedCriteria.FALSE : ItemUpgrader.TYPED_CRITERIA_REGISTRY.get().getValue(this.type);
	}
